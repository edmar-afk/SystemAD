...
var quizQuestion = {
    ...
    questions: [
        {
            // question text
            questionText: "Schedule of planned maintenance actions aimed at the prevention of breakdowns and failures.",
            // question answers array
            questionAnswer: ["Corrective Maintenance.", "Post Implementation", "Preventive Maintenance", "Predictive Maintenance."],
            // correct answer 
            answer: "Preventive Maintenance"
        },
        {
            questionText: "Techniques that help determine the condition of in-service equipment in order to predict when maintenance should be performed.",
            questionAnswer: ["Technical support", "Predictive Maintenance", "Database Administrator", "Computer operator"],
            answer: "Predictive Maintenance"
        },
        {
            questionText: 'Was developed initially for the GE-645 mainframe and later Honeywell continued it on its Honeywell 6180 machines.',
            questionAnswer: ['Mainframe', 'Multics', 'UNIX', 'General Electric'],
            answer: 'Multics',
        },
        {
            questionText: 'An open source operating system based out of legacy 4.4BSD and 386BSD code base.',
            questionAnswer: ['NetBSD', 'Xinuos OpenServer', 'SCO Open Desktop', 'Microsoft'],
            answer: 'NetBSD',
        },
        /*{
        ...
        {
            questionText: 'Uses strict trademark rules to restrict free re-distribution of their officially supported versions of Red Hat Enterprise Linux but still freely provides its source code.',
            questionAnswer: ["Academic", "Red Hat", "Entry-level Server", "Server"],
            answer: "Red Hat",
        },
        /*{
